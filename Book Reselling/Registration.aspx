...
Full Name:<br /><br />
 ...
 <br />
    ...
    <br />
 Mobile Number:<br /><br /><asp:TextBox ID="mobile" runat="server" ValidationGroup="int"></asp:TextBox>
    ...
    <asp:CompareValidator ID="CompareValidator2" Operator="DataTypeCheck" Type="Integer" ForeColor="Red" runat="server" ControlToValidate="mobile" ErrorMessage="value must be number"></asp:CompareValidator>

   <br /><br />
   Password:<br /><br /><asp:TextBox ID="password" runat="server" TextMode="Password" CausesValidation="True"></asp:TextBox>
    
    <br />
    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ForeColor="Red" runat="server" ErrorMessage="only numeric value" ControlToValidate="cpassword"></asp:RequiredFieldValidator>
     <br />
